  ...
  return (
    <Link href={`/deals/${deal.id}`} passHref legacyBehavior>
      <a className="block h-full">
        <Card className="overflow-hidden transition-all hover:shadow-xl duration-300 ease-in-out transform hover:-translate-y-1 flex flex-col h-full cursor-pointer">
